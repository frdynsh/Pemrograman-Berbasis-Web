<?php include_once __DIR__ . '/../proses/proses_daftar_pelanggan.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
   <meta charset="UTF-8">
       ...
       <table class="table table-striped">
           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td>
                       <a href="../views/form_edit_pelanggan.php?id=<?php echo $row['ID'] ?>" class="btn btn-sm btn-warning">Edit</a>
                       <a href="../proses/proses_hapus_pelanggan.php?id=<?php echo $row['ID'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                   </td>
               </tr>
               <?php endwhile; ?>
           </tbody>
